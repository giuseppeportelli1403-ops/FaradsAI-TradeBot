...
- `analyst_decision`: APPROVE / REJECT — what the analyst returned. Some pre-2026-05-12 rows may show a legacy third verdict; treat any non-APPROVE value as REJECT-equivalent for lesson extraction.
